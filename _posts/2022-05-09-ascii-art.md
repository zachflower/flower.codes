...
[Convertcase.net](https://convertcase.net/ascii-art-generator/) has a pretty solid image-to-ascii converter that you can use. As an example, here's the typewriter from my post [Get A Typewriter. Write a Friend.](/2020/12/14/get-a-typewriter-write-a-friend.html) converted into ASCII art.
